...
@nogc nothrow:
	...
	*/
	...
	package(godot) static GodotMethod!(void, RID, RID, RID, RID) _GODOT_canvas_item_add_mesh;
	...
	*/
	void canvasItemAddMesh(in RID item, in RID mesh, in RID texture, in RID normal_map = RID.init)
	{
		...
		ptrcall!(void)(_GODOT_canvas_item_add_mesh, _godot_object, item, mesh, texture, normal_map);
	}
	package(godot) static GodotMethod!(void, RID, RID, RID, RID) _GODOT_canvas_item_add_multimesh;
	...
	*/
	void canvasItemAddMultimesh(in RID item, in RID mesh, in RID texture, in RID normal_map = RID.init)
	{
		...
		ptrcall!(void)(_GODOT_canvas_item_add_multimesh, _godot_object, item, mesh, texture, normal_map);
	}
